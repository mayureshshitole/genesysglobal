...
const Services = () => {
  return (
    <div className="py-16 bg-indigo-500" id="services">
      ...
      <div className="sm:flex flex-wrap justify-center items-center text-center gap-8  min-h-3/4 py-10 px-2 h-3/4">
        {data.services.map((service, index) => (
          <div
            ...
            key={index}
            className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 h-60 px-4 py-4 bg-white mt-6  shadow-lg shadow-indigo-500 rounded-lg "
          >
            ...
            <p className="text-md  text-gray-500  py-4">{service.desc}</p>
          </div>
        ))}
      </div>
    </div>
